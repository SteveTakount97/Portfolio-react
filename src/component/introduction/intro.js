  ...
  return (
    <section id="hero">
      ...
      <h1><span ref={el}></span></h1>
        <p className='intro vertical-bar'>Ancien juriste diplômé d’un master en droit fiscal, et désormais développeur web en reconversion. 
          ...
          <br/>  
        <div className='cv'>
        <a href={`${process.env.PUBLIC_URL}/CV_Professionnel_Steve.pdf`}  download="CV_Professionnel_Steve.pdf" className="btn">Télécharger mon CV</a>
        </div>  
      </div>
    </section>
  );
